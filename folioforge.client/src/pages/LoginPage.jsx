 ...
 * LoginPage
 * 
 * Full-screen login form with dark/gradient design matching the portfolio theme.
...
export const LoginPage = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            setError(err?.details?.error || err?.message || 'Login failed. Please try again.');
        } finally {
            setSubmitting(false);
        }
    };
        ...
        <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-slate-950 via-slate-900 to-slate-950 px-4">
            ...
            >
                ...
                <div className="text-center mb-8">
                    ...
                    <p className="text-slate-400 mt-2">Sign in to your portfolio workspace</p>
                </div>
